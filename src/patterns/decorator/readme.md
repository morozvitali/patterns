Привіт, Віталію! 🔧 Сьогодні беремося за патерн "Декоратор" (Decorator pattern)
— це один із фундаментальних структурних шаблонів проєктування,
який дозволяє додавати нову поведінку об'єктам динамічно, без зміни їхнього коду.
